...
public class DamagingObjectShooter : InteractableItem
{
    ...
    IEnumerator ShootingRoutine(GameContextManager gameContextManager)
    {
        ...
        GameContextManager.Instance.AudioManager.PlaySFX("Fire_Shot", AudioSource);
    ...
    IEnumerator SeparatedShootingRoutine(GameContextManager gameContextManager)
    {
        foreach (var shooter in _shooters)
        {
            ...
            GameContextManager.Instance.AudioManager.StopSFX(shooter.AudioSource);
            GameContextManager.Instance.AudioManager.PlaySFX("Fire_Shot", shooter.AudioSource);
